    ...
    <div class="container">
        ...
        <div class="row">
            ...
            if (!$this->session->userdata('form_data')) { ?>
                ...
                ?>
                    <div class="col-6 mt-3">
                        <img class="img-fluid cek-siteplan" src="<?= base_url('upload'); ?>/<?= $data->foto_hed; ?>" data-perum="<?= $nama; ?>" data-bs-toggle="modal" data-bs-target="#modal-formulir" style="border-radius: 9px;">
                    </div>
                <?php
                endforeach;
                ?>
            ...
            ?>
                ...
                ?>
                    <div class="col-6 mt-3">
                        <a href="<?= base_url('Client'); ?>/visit/<?= $nama; ?>">
                            <img class="img-fluid" src="<?= base_url('upload'); ?>/<?= $data->foto_hed; ?>" style="border-radius: 9px;">
                        </a>
                    </div>
                <?php
                endforeach;
