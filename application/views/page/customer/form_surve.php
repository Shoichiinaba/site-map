    ...
    <div class="container-fluid py-4">
        <div class="card-body px-0 pt-0 pb-2">
            <div class="row mb-2">
                ...
                <?php endif; ?>
                <div class="col-lg-2 col-xxl-2 col-md-3">
                    <a id="cetak" target="_blank" href="<?php echo site_url('Lap_kunjungan'); ?>">
            ...
            <div class="table-responsive p-0">
                <table id="list-visit" class="table align-items-center mb-0">
                    <thead>
                        <tr>
                            <th>No.</th>
                            <?php if ($userdata->role == 'Admin') : ?>
            ...
            <form id="input-survey">
                <div class="modal-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <div class="input-wrapper">
                                <input type="text" id="keterangan" class="col-lg-12" required>
                    ...
                    <div class="row mb-2">
                        <div class="col-md-6">
                            <div class="input-wrapper">
                                ...
                                <select type="text" id="sumber" class="col-lg-12" required>
                        ...
                        <div class="col-md-6">
                            <div class="input-wrapper">
                                <textarea type="text" id="hasil-fu" class="col-lg-12" required></textarea>
...
$(document).ready(function() {
    ...
    var picker;
    var table = $('#list-visit').DataTable({
        "paging": true,
        "autoWidth": true,
        "search": true,
        "responsive": true,
        ...
        "serverSide": true,
        "ajax": {
            "url": "<?=site_url('Customer/get_customer_visit')?>",
            "type": "POST",
            "data": function(d) {
    ...
    function printFilteredData() {
        ...
        var printUrl = "<?=site_url('Lap_kunjungan')?>";
...
$('#input-survey').submit(function(event) {
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo base_url('Customer/input_survey') ?>',
        data: {
        ...
        success: function(response) {
            if (response.status) {
                ...
                window.location.href =
                    "<?php echo base_url('Customer/customer_visit'); ?>";
            } else {
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.status) {
                ...
                window.location.href = "<?php echo base_url('Customer/customer_visit'); ?>";
            } else {
                // Gagal
...
// Fungsi untuk mengambil data kapling
function getKaplingOptions(selectedValue) {
    $.ajax({
        type: "POST",
        url: "<?php echo base_url('Customer/get_kapling_options'); ?>",
        data: {
            unit: selectedValue,
        },
...
// Pemanggilan fungsi saat dokumen siap
$(document).ready(function() {
    getKaplingOptions($('#unit-edit').val());
});

// panggil setiap kali modal dibuka
$('#edit-data').on('shown.bs.modal', function() {
    getKaplingOptions($('#unit-edit').val());
});

// perubahan pada elemen #unit-edit
$(document).on('change', '#unit-edit', function() {
    var selectedValue = $(this).val();

    getKaplingOptions(selectedValue);
});

// Akhir fungsi untuk mengambil data kapling

function sendUnitToController(unit) {
    $.ajax({
        type: "POST",
        url: "<?php echo base_url('Customer/get_kapling_options'); ?>",
        data: {
