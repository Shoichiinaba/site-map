    ...
    function search()
    {
        ...
        foreach ($resuls as $result) {
            $data_arr[] = [
                ...
                'action' => '<button onclick="openDataRow(\'' . $result->code . '\', \'' . $result->type . '\', \'' . $result->description . '\')" class="btn btn-sm bg-gradient-success" data-bs-toggle="modal" data-bs-target="#exampleModaledit"><i class="fa fa-edit"></i> Edit</button>&nbsp;' .
                    '&nbsp;&nbsp;<button type="button" class="btn btn-sm bg-gradient-primary" data-bs-toggle="modal" data-bs-target="#exampleModalatt"><i class="fa fa-paperclip"></i> Document</button>'
            ];
        }
