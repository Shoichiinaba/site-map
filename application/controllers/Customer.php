...
class Customer extends AUTH_Controller
{
    ...
    public function edit_data()
    {
        ...
        if (!empty($id)) {
            ...
            $data_trans = array(
                'id_trans_denahs' => $this->input->post('code'),
            ...
            // $update_trans = $this->Visit_model->update_trans('transaksi', $data_trans);
            $result = $this->Visit_model->save_trans($data_trans);

            if ($update_status && $update_denah && $result ) {
